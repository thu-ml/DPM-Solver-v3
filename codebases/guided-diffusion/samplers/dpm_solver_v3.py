...
class DPM_Solver_v3:
    def __init__(
        ...
        self.logSNR_steps = self.noise_schedule.marginal_lambda(self.timesteps)
        print("Indexes", self.indexes)
        print("Time steps", self.timesteps)
        print("LogSNR steps", self.logSNR_steps)
    ...
    def sample(
        self, x, model_fn, order, p_pseudo, use_corrector, c_pseudo, lower_order_final, return_intermediate=False
    ):
